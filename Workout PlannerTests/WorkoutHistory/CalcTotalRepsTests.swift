...
class CalcTotalRepsTests: XCTestCase {
    ...
    func testCalcTimeDone() throws {
        let total = calcTotalReps(sets: Int(workout.sets), exercises: workout.exerciseArray)
        print(total)
        XCTAssertTrue(total == 35)
    }
}
